...
func Init() (*DatabaseProvider, error) {
	...
	// reform-db -db-driver=sqlserver -db-source='server=localhost;user=admin;password=Kot_456789;port=1433;database=mainDb;' init -gofmt=false
	// reform-db -db-driver=sqlserver -db-source='server=192.168.1.134;user=admin;password=Kot_456789;port=1433;database=mainDb;' init -gofmt=false
